...
word_counts %>%
  ...
  labs(title = "Top 20 Most Common Words (with Stop Words)", 
       subtitle = paste(" Most common word (with stopwords):", top_word_with_sw, "(in red)\n",
                        "Most common word (no stopwords):", top_word_no_sw, "(in green)"),
       x = "Words", y = "Frequency") +
  theme_minimal() +
...
Stemming is the process of reducing words to their root form, which helps to group together words with similar meanings. We can apply stemming to the tokenized reviews using the `wordStem()` function from the `SnowballC` package.
